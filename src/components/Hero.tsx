...
const Hero = () => {
  return <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-xl animate-fade-up">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight mb-6">
            L'Art de la 
            <span className="text-gradient block text-yellow-700">Parfumerie</span>
          </h1>
